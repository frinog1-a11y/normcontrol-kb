...
const config: QuartzConfig = {
  configuration: {
    ...
    theme: {
      ...
      colors: {
        // «Мягкая лаванда»: светло-лавандовый фон, глубокий фиолетово-серый текст,
        // лавандовые ссылки, тёплый розовый акцент
        lightMode: {
          light: "#f7f5fa", // фон: светло-лавандовый
          ...
          secondary: "#7a6a9a", // ссылки: мягкий лавандовый
